...
function Excursions(props){
    ...
    /** Array that saves the excursions that have to be displayed, this can display the entire lists of excursions we have on the server (if the user didn't search for anything in the search bar, the filters or
