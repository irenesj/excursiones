...
import { Button, SplitButton, Dropdown, Container, Row, Col } from 'react-bootstrap';
                ...
                <Col xs="12" md="7" xl="12">
                    <SplitButton className={styles.userProfile} variant="success" title={text} >
                        ...
                        <Dropdown.ItemText className={styles.dropdownText}>
                            <Button className={styles.logoutBtn} variant="secondary" onClick={logOut}>Cerrar sesión</Button>
                        </Dropdown.ItemText>
                    </SplitButton>
                </Col>
            </Row>
